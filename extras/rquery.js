...
var __block__ = ($block.f == arguments.callee)? $block.p : nil;$block.p = $block.f = nil;return ((((__block__ !== nil ? Qtrue : Qfalse).$r) ? $(function() { __block__(__block__.$self); }):nil), self);}, 1));}, 2));})();
});
...
return (self.$m.from_native(self, $(selector)));}, 1), self.$m.alias_method(self, $symbol("[]"), $symbol("find")), $def(self, "new", function(self, type) {
if (type === undefined) type = 'div';
return $(document.createElement(type));}, 1), $def(self, "from_native", function(self, elem) {
return $(elem);}, 1), $def(self, "length", function(self) {
return self.length;}, 0), self.$m.alias_method(self, $symbol("size"), $symbol("length")), $def(self, "[]", function(self, index, count) {
...
var size = self.length;
    ...
    return $(self[index]);}, 0), $def(self, "selector", function(self) {
return self.selector;}, 0), $def(self, "each", function(self) {
var __block__ = ($block.f == arguments.callee)? $block.p : nil;$block.p = $block.f = nil;var length = self.length;
    ...
    return self;}, 0), $def(self, "attr", function(self, name, value) {
var __a;
if (value === undefined) value = nil;
return (((__a = value).$m["nil?"](__a).$r ? (self.attr((__a = name).$m.to_s(__a)) || '') : (self.attr((__a = name).$m.to_s(__a), value))));}, 0), $def(self, "id", function(self, value) {
if (value === undefined) value = nil;
return ((value.$r ? (self.attr('id', value), self) : (self.attr('id'))));}, 0), $def(self, "id=", function(self, value) {
return (self.attr('id', value), value);}, 0), $def(self, "html", function(self, content) {
