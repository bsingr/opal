...
return ($class(self, nil, "String", function() {
var self = this;return ($def(self, "*", function(count) {
var self = this;
var result = [];
...
var self = this;
return self + other;}, 0), $def(self, "capitalize", function() {
var self = this;
return self.charAt(0).toUpperCase() + self.substr(1).toLowerCase();}, 0), $def(self, "downcase", function() {
var self = this;
return self.toLowerCase();}, 0), $def(self, "to_s", function() {
var self = this;
return (self);}, 0), $def(self, "inspect", function() {
var self = this;
return '"' + self + '"';}, 0), $def(self, "length", function() {
var self = this;
return self.length;}, 0), $def(self, "to_sym", function() {
var self = this;
return opalsym(self);}, 0), $def(self, "intern", function() {
var self = this;
return opalsym(self);}, 0), $def(self, "reverse", function() {
var self = this;
return self.split('').reverse().join('');}, 0), $def(self, "sub", function(pattern) {
var self = this;
...
var self = this;
return self.split(split);}, 0), $def(self, "<=>", function(other) {
var self = this;
...
var self = this;
return self.valueOf() === other.valueOf() ? Qtrue : Qfalse;}, 0), $def(self, "=~", function(obj) {
var self = this;
return (obj.m$match(self), nil);}, 0), $def(self, "casecmp", function(other) {
var self = this;
if (typeof other != 'string') return nil;
...
var self = this;
return self.length == 0 ? Qtrue : Qfalse;}, 0), $def(self, "end_with?", function(suffix) {
var self = this;
...
var self = this;
return self == other ? Qtrue : Qfalse;}, 0), $def(self, "include?", function(other) {
var self = this;
return self.indexOf(other) == -1 ? Qfalse : Qtrue;}, 0), $def(self, "index", function(substr) {
var self = this;
