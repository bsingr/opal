...
$class(self, nil, "String", function() {var self = this;  

  $def(self, "new", function(str) {var self = this;    
  ...
  $def(self, "capitalize", function() {var self = this;    
  ...
  $def(self, "downcase", function() {var self = this;    
  ...
  $def(self, "to_sym", function() {var self = this;    
    return $opal.Y(self);
  }, 0);  

  $def(self, "intern", function() {var self = this;    
    return $opal.Y(self);
  }, 0);  
  ...
  $def(self, "sub", function(pattern) {var self = this;    
    return self.replace(pattern, function(str) {
      return __block__.call(__block__.$self);
    });
  }, 0);  

  $def(self, "gsub", function(pattern) {var self = this;    
  ...
  $def(self, "slice", function(start, finish) {var self = this;    
    return self.substr(start, finish);
  }, 0);  

  $def(self, "split", function(split) {var self = this;    
  ...
  $def(self, "casecmp", function(other) {var self = this;    
    if (typeof other != 'string') return nil;
  ...
  $def(self, "end_with?", function(suffix) {var self = this;    
  ...
  $def(self, "include?", function(other) {var self = this;    
  ...
  $def(self, "index", function(substr) {var self = this;    
  ...
  $def(self, "lstrip", function() {var self = this;    
