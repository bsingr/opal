...
var VALID_CMD_BEGIN = ['IDENTIFIER', 'IDENTIFIER2', 'CONSTANT', 'STRING_BEGIN', 'XSTRING_BEGIN', 'SYMBEG', 'INTEGER', 'FLOAT', 'ARRAY_BEGIN', 'SELF', 'TRUE', 'FALSE', 'NIL', 'IVAR', 'LABEL', 'UMINUS', 'UPLUS', 'FILE', 'LINE', 'STAR',
