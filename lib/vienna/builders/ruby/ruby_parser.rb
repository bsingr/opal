...
module_eval(<<'...end ruby_parser.rb.y/module_eval...', 'ruby_parser.rb.y', 1437)
...
module_eval(<<'.,.,', 'ruby_parser.rb.y', 1038)
...
module_eval(<<'.,.,', 'ruby_parser.rb.y', 1198)
...
module_eval(<<'.,.,', 'ruby_parser.rb.y', 1345)
...
module_eval(<<'.,.,', 'ruby_parser.rb.y', 1398)
