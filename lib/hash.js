...
return ($class(self, nil, "Hash", function() {
var self = this;return ($def(self, "values", function() {
var self = this;
...
var self = this;
return self.$default;}, 0), $def(self, "default=", function(obj) {
var self = this;
return self.$default = obj;}, 0), $def(self, "delete", function(key) {
var self = this;
var assoc = key.$hash();
...
var self = this;
return self.$keys.length == 0 ? Qtrue : Qfalse;}, 0), $def(self, "fetch", function(key, defaults) {
var self = this;
...
var self = this;
return (nil);}, 0), $def(self, "key", function(value) {
var self = this;
var key, val;
...
var self = this;
return self.$keys.slice(0);}, 0), $def(self, "length", function() {
var self = this;
return self.$keys.length;}, 0), $def(self, "merge", function(other) {
var self = this;
