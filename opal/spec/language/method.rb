describe "Calling a method" do
  ...
  it "works with rest arguments" do
    ...
    raise "not finished implementing all examples"
  end
  
  it "with an empty expression is like calling with nil arguments" do
    def foo(a); a; end
    foo(()).should be_nil
  end
  ...
  it "with block argument converts to block to proc" do
