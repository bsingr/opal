...
MathParser.prototype.do_parse = function() {
  return this.do_parse_js(MathParser.Racc_arg, false);
};

MathParser.prototype.do_parse_js = function(arg, in_debug) {
...
MathParser.prototype.next_token = function() {
  throw "next_token is not defined for parser."
};

MathParser.prototype._reduce_none = function(val, result) {
  return result;
};
MathParser.Racc_arg = [
[3,3,3,3,9,5,4,4,4,4,6,6,7,7,6,12],[0,6,7,4,5,1,0,6,7,4,8,2,8,2,11,8],[-6,-6,-1,-5,-6,-6,-6,-6,-6,13,-3,-2,-4],[-2,5,7,null,1,4,-1,0,6,null,null,10,null],[2,1,null,null,8,null,10,11],[2,1,null,null,2,null,2,2],[null,null,null],[null,1,0],10,[0,0,"racc_error",1,11,"_reduce_1",3,12,"_reduce_2",3,12,"_reduce_none",3,12,"_reduce_none",1,12,"_reduce_none"],{"+": 6,"UMINUS": 3,"false": 0,"-": 7,"/": 5,"error": 1,"(": 8,")": 9,"NUMBER": 2,"*": 4},13,6,true];
        MathParser.prototype._reduce_1 = function(val, result) {
          result = val[0];
          return result;
        };
        MathParser.prototype._reduce_2 = function(val, result) {
          a, b, c
          return result;
        };
