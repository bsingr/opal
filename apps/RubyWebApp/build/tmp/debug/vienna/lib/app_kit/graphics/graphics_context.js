(function(self) {
(function(self) {
rb_define_method(self,s$i,function(self,_cmd,graphics_port,flip_state){
...
rb_ivar_get(self, i$ah).moveTo(rb_funcall(point,s$v),rb_funcall(point,s$w))});
rb_define_method(self,s$gs,function(self,_cmd,point){
rb_ivar_get(self, i$ah).lineTo(rb_funcall(point,s$v),rb_funcall(point,s$w))});
rb_define_method(self,s$gt,function(self,_cmd,cp1,cp2,point){
rb_ivar_get(self, i$ah).bezierCurveTo(rb_funcall(cp1,s$v),rb_funcall(cp1,s$w),rb_funcall(cp2,s$v),rb_funcall(cp2,s$w),rb_funcall(point,s$v),rb_funcall(point,s$w))});
