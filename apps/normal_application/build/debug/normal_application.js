...
var vn_cBundle=rb_define_class('Bundle',rb_cObject);var vn_current_bundle=null;var vn_all_bundles=[]
function vn_bundle_add_class_to_current_bundle(self,_cmd,klass){if(!RTEST(rb_ivar_get(self,'@current_bundle'))){}
else{}};function vn_bundle_begin_new_bundle(self,_cmd,bundle_identifier){var bundle=rb_funcall(self,'new',bundle_identifier);vn_all_bundles.push(bundle);vn_current_bundle=bundle;};function vn_bundle_initialize(self,_cmd,bundle_identifier){rb_ivar_set(self,'@bundle_identifier',bundle_identifier);};function vn_bundle_add_resource_to_current_bundle(self,_cmd,resource_path,resource_text){};function vn_bundle_set_info_dictionary_for_current_bundle(self,_cmd,info_dictionary){};rb_define_singleton_method(vn_cBundle,'add_class_to_bundle',vn_bundle_add_class_to_current_bundle);rb_define_singleton_method(vn_cBundle,'begin_new_bundle',vn_bundle_begin_new_bundle);rb_define_singleton_method(vn_cBundle,'add_resource_to_current_bundle',vn_bundle_add_resource_to_current_bundle);rb_define_singleton_method(vn_cBundle,'set_info_dictionary_for_current_bundle',vn_bundle_set_info_dictionary_for_current_bundle);rb_define_method(vn_cBundle,'initialize',vn_bundle_initialize);
...
function vn_binary_plist_parse(parse_text){var hash=function(c){var result={};var hash_len=marker_count();for(var i=0;i<hash_len;i++){var key=value();var val=value();result[key]=val;}
...
return parseInt(len);};var plist_format=function(){var marker=text.indexOf('$',at);var format=text.substr(at,marker-at);at=marker+1;return format;};var plist_version=function(){var marker=text.indexOf('$',at);var version=text.substr(at,marker-at);at=marker+1;return version;};at=0;ch='';text=parse_text
format=plist_format();version=plist_version();result=value();return result;};var vn_plist_test_string="vnplist$1.0$a5$s10$this worksh1$s6$beynons4$adam~$i4$1034d8$12.43563";console.log('plist Result:');console.log(vn_binary_plist_parse(vn_plist_test_string));
_I=rb_define_method;
_C=ANDTEST;
...
rb_oENV = VN.$h('display_mode', 'render', 'image_dir', 'images');rb_cObject.$c_s('ENV', rb_oENV);rb_funcall(vn_cBundle, 'begin_new_bundle', 'com.yourcompany.browser');
rb_funcall(vn_cBundle, 'set_info_dictionary_for_current_bundle', {"bundle_icon_file":"","bundle_identifier":"com.yourcompany.browser","principal_class":"VN::Application","main_vib_file":"main_menu","bundle_package_type":"APPL","bundle_name":"browser","bundle_development_region":"English"});
...
rb_funcall(vn_cBundle, 'begin_new_bundle', 'com.yourcompany.foundation');
rb_funcall(vn_cBundle, 'set_info_dictionary_for_current_bundle', {"bundle_icon_file":"","bundle_identifier":"com.yourcompany.foundation","principal_class":"VN::Application","main_vib_file":"main_menu","bundle_package_type":"APPL","bundle_name":"foundation","bundle_development_region":"English"});
(function(self) {
...
rb_funcall(vn_cBundle, 'begin_new_bundle', 'com.yourcompany.app_kit');
rb_funcall(vn_cBundle, 'set_info_dictionary_for_current_bundle', {"bundle_icon_file":"","bundle_identifier":"com.yourcompany.app_kit","principal_class":"VN::Application","main_vib_file":"main_menu","bundle_package_type":"APPL","bundle_name":"app_kit","bundle_development_region":"English"});
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_disabled_regular_left.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_disabled_regular_middle.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAYCAYAAAA7zJfaAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAEJJREFUeNpi2Lt3bwPD9+/fG5i+fv3KwPT//38Gpn///iETf//+xeAixLDJohkANvT8+fMMDMrKyhJMDAwMHwACDADK3EKPoNn6DQAAAABJRU5ErkJggg==");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_disabled_regular_right.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_highlighted_regular_left.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_highlighted_regular_middle.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAYCAYAAAA7zJfaAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAD9JREFUeNpinDx58n8mAwMDBiYgYGBiZGSEshAEMzMzdi6YhVMWTjB8+/btP8uxY8cYGJWVlQ2YhYSEfgAEGAAQGgvqusZZvQAAAABJRU5ErkJggg==");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_highlighted_regular_right.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_normal_regular_left.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_normal_regular_middle.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAYCAYAAAA7zJfaAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAFZJREFUeNpsx7EJwCAYBeHDCbKDC2R/cAY3+BFBRLS30heSNCnSfNwRQhBzTjHGEL130VoTtVZRShE5Z5FSEmYmt9biZe/9rb99kISLMYL3/rw5LgEGADhtSOP0JUTjAAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/button_bezel_normal_regular_right.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/hud_window_background.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA9JREFUeNpi1NPTewYQYAACjgFyr/seWgAAAABJRU5ErkJggg==");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/horizontal/scroller_horizontal_knob_left.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/horizontal/scroller_horizontal_knob_middle.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAARCAYAAAAcw8YSAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAE9JREFUeNo0xLsJwzAAQMEHWcKB7BBw43W8uho1EpL1bV+qXHGo8E/23rLWkjmnjDGk9y6tNam1SilFcs6SUpIYo4QQ5Hte9+t4f56fAAMANTs5szn29v4AAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/horizontal/scroller_horizontal_knob_right.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/horizontal/scroller_horizontal_track.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAARCAIAAACToVFFAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAADFJREFUeNo8x1EKAEAIQkEyvf9BOmO12McKw0NUFUhC0udvmQnPjYizu6e7MTPuE2AAMrMRdXObRokAAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/horizontal/scroller_left_arrow.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/horizontal/scroller_right_arrow.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/vertical/scroller_bottom_arrow.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/vertical/scroller_top_arrow.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/vertical/scroller_vertical_knob_bottom.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/vertical/scroller_vertical_knob_middle.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAABCAYAAAA4u0VhAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACtJREFUeNpi/P//PwMU/P/+/TsDiI+O//37h0L//v0bjP0CwxKB+g4ABBgAo30pujUhEEwAAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/vertical/scroller_vertical_knob_top.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/scrollers/vertical/scroller_vertical_track.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAABCAIAAAC32dI2AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACxJREFUeNpiXL16NQsLCysMsIABMzMzExMTkGQEg/9g8Pfv33///gFJgAADAOtDEVS8zMtUAAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/switch/switch_blue_regular_alternate.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/switch/switch_blue_regular_normal.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/table_view/header_view_background.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAARCAIAAACToVFFAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACZJREFUeNpiev/+PdO/f/9Q8N+/f8H4z58/cDY6H6b20qVLAAEGAK1aMesKVSoCAAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_0.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAADCAIAAAA2iEnWAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABxJREFUCB1jmTNnDicnJ4uMjIywsDALEEtKSgIALM0DDeT4y3sAAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_1.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAADCAIAAADdv/LVAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABRJREFUCB1jWLVqFZOWlhbDx48fARyiBVLivNzsAAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_2.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAADCAIAAAA2iEnWAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAB1JREFUCB1jWrp06Zw5c5jU1NRkZGSYJCUlhYWFAUybBRTduo1wAAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_3.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAABCAIAAAB7QOjdAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA9JREFUCB1juHLlysePHwESGQVQhb5n0gAAAABJRU5ErkJggg==");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_4.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAAxJREFUCB1j+P//PwAF/gL+n8otEwAAAABJRU5ErkJggg==");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_5.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAABCAIAAAB7QOjdAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA9JREFUCB1j/Pjx4+PHjwETfwV+HAwP5QAAAABJRU5ErkJggg==");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_6.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAIAAAD91JpzAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABZJREFUCB1jvHLliqysLOPp06clJSUBLX0FglncIWUAAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_7.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAIAAAAW4yFwAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABBJREFUCB1j+P//P9OnT58AF6oF1hwiRUMAAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/text_field/text_field_square_bezel_8.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAIAAAD91JpzAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABZJREFUCB1j/vjxY0xMDHNOTs779+8BN9MH/68NXLgAAAAASUVORK5CYII=");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/window/normal_window_view/normal_window_close_button.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/window/normal_window_view/normal_window_resize_indicator.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAYAAABWdVznAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAF9JREFUKJFj+P//PwOx2NjYOJIkxUDalSTFQMxPkmIQnyTF0tLSASQpBtLOJCkGYlmSFGP4gZBiBQWFIJIUw+OBWMVALMkABHZAhg1MMQcHhxeQtoMp5uLi8obyJUF8ACitf5AUaj8yAAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/window/normal_window_view/normal_window_titlebar_left.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/window/normal_window_view/normal_window_titlebar_middle.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAA3CAIAAABCVLduAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACZJREFUeNpifPXqFRMDAwPT////cdLobGx8XGLUUoPPfhzuBggwAAdIerS2W++4AAAAAElFTkSuQmCC");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/window/normal_window_view/normal_window_titlebar_right.png", "data:image/png;base64,");
rb_funcall(vn_cBundle, 'add_resource_to_current_bundle', "/resources/window/normal_window_view/normal_window_titlebar_splitter.png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA9JREFUeNpimD59OkCAAQADjgHGv2lW9AAAAABJRU5ErkJggg==");
...
rb_funcall(nc,'remove_observer:name:object:',rb_ivar_get(self,'@delegate'),self.$klass.$c_g_full('APP_WILL_FINISH_LAUNCHING'),self);
rb_funcall(nc,'remove_observer:name:object:',rb_ivar_get(self,'@delegate'),self.$klass.$c_g_full('APP_DID_FINISH_LAUNCHING'),self);
...
rb_funcall(nc,'add_observer:selector:name:object:',rb_ivar_get(self,'@delegate'),'will_finish_launching',self.$klass.$c_g_full('APP_WILL_FINISH_LAUNCHING'),self);
}
if(RTEST(rb_funcall(rb_ivar_get(self,'@delegate'),'respond_to?',ID2SYM('did_finish_launching')))){
rb_funcall(nc,'add_observer:selector:name:object:',rb_ivar_get(self,'@delegate'),'did_finish_launching',self.$klass.$c_g_full('APP_DID_FINISH_LAUNCHING'),self);
}
});
...
rb_funcall(nc,'post_notification_name:object:',self.$klass.$c_g_full('APP_WILL_FINISH_LAUNCHING'),self);
return rb_funcall(nc,'post_notification_name:object:',self.$klass.$c_g_full('APP_DID_FINISH_LAUNCHING'),self);
});
...
(function(self) {
(function(self) {
var adam=rb_funcall(self.$c_g_full('ThreePartImage'),'new');
self.$c_s('BEZEL_IMAGES',VN.$h(ID2SYM('round_textured'), VN.$h(ID2SYM('regular'), VN.$h(ID2SYM('normal'), rb_funcall(self.$c_g_full('ThreePartImage'),'new',rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_normal_regular_left'),rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_normal_regular_middle'),rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_normal_regular_right')), ID2SYM('highlighted'), rb_funcall(self.$c_g_full('ThreePartImage'),'new',rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_highlighted_regular_left'),rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_highlighted_regular_middle'),rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_highlighted_regular_right')), ID2SYM('disabled'), rb_funcall(self.$c_g_full('ThreePartImage'),'new',rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_disabled_regular_left'),rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_disabled_regular_middle'),rb_funcall(self.$c_g_full('Image'),'image_named','button_bezel_disabled_regular_right'))), ID2SYM('small'), VN.$h(), ID2SYM('mini'), VN.$h()), ID2SYM('push'), VN.$h(ID2SYM('regular'), VN.$h(), ID2SYM('small'), VN.$h(), ID2SYM('mini'), VN.$h())));
...
var bezel_img=rb_funcall(rb_funcall(rb_funcall(self.$klass.$c_g_full('BEZEL_IMAGES'),'[]',ID2SYM('round_textured')),'[]',ID2SYM('regular')),'[]',RTEST(rb_ivar_get(self,'@enabled')) ? (RTEST(rb_ivar_get(self,'@highlighted')) ? ID2SYM('highlighted') : ID2SYM('normal')) : ID2SYM('disabled'));
...
rb_funcall(vn_cBundle, 'begin_new_bundle', 'com.yourcompany.vienna');
rb_funcall(vn_cBundle, 'set_info_dictionary_for_current_bundle', {"bundle_icon_file":"","bundle_identifier":"com.yourcompany.vienna","principal_class":"VN::Application","main_vib_file":"main_menu","bundle_package_type":"APPL","bundle_name":"vienna","bundle_development_region":"English"});
(function(self) {
...
rb_funcall(vn_cBundle, 'begin_new_bundle', 'com.adambeynon.NormalApplication');
rb_funcall(vn_cBundle, 'set_info_dictionary_for_current_bundle', {"bundle_icon_file":null,"bundle_identifier":"com.adambeynon.NormalApplication","principal_class":"VN::Application","main_vib_file":"main_menu","bundle_package_type":"APPL","bundle_name":"NormalApplication","bundle_development_region":"English"});
(function(self) {
(function(self) {
...
})(rb_define_module('NormalApplication'));
