vnlib$1.0$e49$h2$s9$image_dirs6$imagess12$display_modes6$renderc249$_I=rb_define_method;_C=ANDTEST;_J=rb_define_singleton_method;_E=rb_funcall;_B=ORTEST;_A=RTEST;_M=rb_define_class;_K=rb_define_module;_N=rb_define_class_under;_L=rb_define_module_under;_H=rb_ivar_get;_O=ID2SYM;_G=rb_ivar_set;_F=rb_supcall;_D=NOTTEST;b6289$vnfmwk$1.0$p8$/browserr261$8$info.yml247$vnplist$1.0$h7$s16$bundle_icon_files0$s17$bundle_identifiers23$com.yourcompany.browsers15$principal_classs15$VN::Applications13$main_vib_files9$main_menus19$bundle_package_types4$APPLs11$bundle_names7$browsers25$bundle_development_regions7$Englishc5995$
(function(self) {
...
b21509$vnfmwk$1.0$p11$/foundationr268$8$info.yml254$vnplist$1.0$h7$s16$bundle_icon_files0$s17$bundle_identifiers26$com.yourcompany.foundations15$principal_classs15$VN::Applications13$main_vib_files9$main_menus19$bundle_package_types4$APPLs11$bundle_names10$foundations25$bundle_development_regions7$Englishc21203$(function(self) {
...
var id=rb_funcall(ctx,'[]','id');
var class_str=rb_funcall(ctx,'[]','class');
var obj_class=rb_funcall(self.$klass.$c_g_full('Object'),'full_const_get',class_str);
var keys=rb_funcall(ctx,'[]','keys');
...
rb_funcall(self,'puts',"its a number!");
}
else{
...
b1130$vnfmwk$1.0$p0$r280$8$info.yml266$vnplist$1.0$h7$s16$bundle_icon_file~$s17$bundle_identifiers32$com.adambeynon.NormalApplications15$principal_classs15$VN::Applications13$main_vib_files9$main_menus19$bundle_package_types4$APPLs11$bundle_names17$NormalApplications25$bundle_development_regions7$Englishr592$23$resources/main_menu.vib562$vnplist$1.0$h3$s12$root_objectsa1$h3$s4$keysh5$s17$visible_at_launcht$s12$content_viewh3$s4$keysh2$s8$subviewsa1$h3$s4$keysh5$s14$next_responderd4$1002s4$cellh3$s4$keysh3$s8$borderedt$s7$enabledt$s7$bezeledt$s5$classs14$VN::ButtonCells2$idd4$1005s9$superviewd4$1002s7$enabledt$s5$frames22${{100, 20}, {120, 24}}s5$classs10$VN::Buttons2$idd4$1004s5$frames20${{0, 0}, {600, 200}}s5$classs8$VN::Views2$idd4$1002s5$classs10$VN::Windows5$titles11$Main Windows5$frames24${{200, 200}, {600, 200}}s5$classs18$VN::WindowTemplates2$idd4$1001s7$classesa0$s11$connectionsa0$c229$(function(self) {
(function(self) {
