...
(function(self) {
(function(self) {
self.$def_s('map',function(self,_,options,block){
});
})(rb_define_module('Mappings'));
})(rb_define_module('Vienna'));
