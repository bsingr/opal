var the_class = objc_allocateClassPair(NSView, "VNCustomView");
...
class_addMethod(the_class, "initWithFrame:", function(self, _cmd, aRect) {
with(self) {
self = objc_msgSendSuper({super_class:NSView, receiver:self}, "initWithFrame:", aRect);
NSLog("initialising");
return self;
}
}, "void");
